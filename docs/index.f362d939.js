...
})({"4mEZT":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "fccad9fc8b7bde3c58223e73f362d939"; // @flow
...
},{}],"1pSq8":[function(require,module,exports) {
console.log("dfds");
var battlefield = new Battlefield(document.getElementById('battlefield'));
/* var c = document.getElementById("battlefield");
var ctx = c.getContext("2d");
var img = new Image();
img.src = './sprites/hero_left' + 0 + '.png'; 

img.onload = () => {
    ctx.drawImage(img, 10, 10);
} */ function Battlefield(battlefield1) {
    this.battlefield = battlefield1;
    this.hero = new Hero();
    this.hero.loadLeft();
    this.refresh = ()=>{
        console.log("refresh!");
...
function Hero() {
    ...
    this.loadLeft = (index)=>{
        let loader = new SpritesLoader('./sprites/', 'hero_left', 4, this.spritesLoaded);
        loader.load();
    };
    this.spritesLoaded = (sprites)=>{
        this.left = sprites;
        setInterval(()=>{
            battlefield.refresh();
        }, 100);
    ...
    this.draw = (ctx)=>{
        ...
        let images;
        if (this.direction === 0) images = this.left;
        else if (this.direction === 1) images = this.right;
        ctx.drawImage(images[this.index], this.posX, this.posY);
    };
}

},{}]},["4mEZT","1pSq8"], "1pSq8", "parcelRequiree868")

//# sourceMappingURL=index.f362d939.js.map
